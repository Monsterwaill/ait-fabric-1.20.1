...
public class ToyotaConsoleModel extends ConsoleModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData lockernob2 = controls.addChild("lockernob2", ModelPartBuilder.create().uv(207, 91).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-1.5F, -3.9015F, -23.3038F, 0.2618F, 0.0F, 0.0F));

		ModelPartData lockernob3 = controls.addChild("lockernob3", ModelPartBuilder.create().uv(207, 88).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -3.9015F, -23.3038F, 0.2793F, 0.0F, 0.0F));

		ModelPartData lockernob4 = controls.addChild("lockernob4", ModelPartBuilder.create().uv(207, 75).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(1.5F, -3.9015F, -23.3038F, 0.2618F, 0.0F, 0.0F));
		...
		ModelPartData cube_r19 = tinylever.addChild("cube_r19", ModelPartBuilder.create().uv(165, 85).cuboid(-0.5F, -1.5088F, 0.0328F, 1.0F, 2.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));

		ModelPartData tinytinyswitch = controls.addChild("tinytinyswitch", ModelPartBuilder.create().uv(69, 178).cuboid(-0.5F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.001F)), ModelTransform.pivot(-3.5F, -4.0F, -21.25F));

		ModelPartData tinytinyswitch2 = controls.addChild("tinytinyswitch2", ModelPartBuilder.create().uv(178, 6).cuboid(-0.5F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.001F)), ModelTransform.pivot(-2.5F, -4.0F, -21.25F));

		ModelPartData tinytinyswitch3 = controls.addChild("tinytinyswitch3", ModelPartBuilder.create().uv(178, 0).cuboid(-0.5F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.001F)), ModelTransform.pivot(-1.5F, -4.0F, -21.25F));

		ModelPartData tinytinyswitch4 = controls.addChild("tinytinyswitch4", ModelPartBuilder.create().uv(175, 65).cuboid(-0.5F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.001F)), ModelTransform.pivot(1.5F, -4.0F, -21.25F));

		ModelPartData tinytinyswitch5 = controls.addChild("tinytinyswitch5", ModelPartBuilder.create().uv(172, 110).cuboid(-0.5F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.001F)), ModelTransform.pivot(2.5F, -4.0F, -21.25F));

		ModelPartData tinytinyswitch6 = controls.addChild("tinytinyswitch6", ModelPartBuilder.create().uv(73, 157).cuboid(-0.5F, -1.0F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.001F)), ModelTransform.pivot(3.5F, -4.0F, -21.25F));

		ModelPartData panel1lights = panel1.addChild("panel1lights", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -15.9359F, -20.5665F));
		...
		ModelPartData cube_r20 = panel2.addChild("cube_r20", ModelPartBuilder.create().uv(175, 0).cuboid(-1.0F, -8.023F, -31.6235F, 2.0F, 2.0F, 22.0F, new Dilation(-0.001F)), ModelTransform.of(0.0F, 2.0391F, 0.0F, -0.2618F, 0.5236F, 0.0F));

		ModelPartData cube_r21 = panel2.addChild("cube_r21", ModelPartBuilder.create().uv(40, 180).cuboid(-1.0F, -15.5F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-14.0582F, 0.5195F, -24.3496F, 0.0F, 0.5236F, 0.0F));

		ModelPartData cube_r22 = panel2.addChild("cube_r22", ModelPartBuilder.create().uv(180, 25).cuboid(-1.0F, -21.023F, -24.3765F, 2.0F, 2.0F, 20.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.2618F, 0.5236F, 0.0F));
		...
		ModelPartData largegear1 = gears.addChild("largegear1", ModelPartBuilder.create(), ModelTransform.pivot(-1.625F, -16.8238F, 6.1851F));

		ModelPartData cube_r25 = largegear1.addChild("cube_r25", ModelPartBuilder.create().uv(207, 0).cuboid(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.of(-1.125F, -0.8945F, -0.2379F, -1.309F, 0.0F, 0.0F));

		ModelPartData cube_r26 = largegear1.addChild("cube_r26", ModelPartBuilder.create().uv(175, 85).cuboid(-1.0F, -0.5F, 0.0F, 2.0F, 1.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(-0.625F, -0.653F, -0.1732F, -1.309F, 0.0F, 0.0F));

		ModelPartData cube_r27 = largegear1.addChild("cube_r27", ModelPartBuilder.create().uv(75, 194).cuboid(-0.5F, -0.5F, -1.0F, 1.0F, 1.0F, 2.0F, new Dilation(0.001F)), ModelTransform.of(0.875F, 0.3129F, 0.0856F, -1.309F, 0.0F, 0.0F));

		ModelPartData cube_r28 = largegear1.addChild("cube_r28", ModelPartBuilder.create().uv(192, 69).cuboid(-2.0F, -2.2F, -0.1F, 4.0F, 4.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.875F, 1.3829F, 0.1582F, -1.309F, 0.0F, 0.0F));
		...
		ModelPartData cube_r32 = tinygear1.addChild("cube_r32", ModelPartBuilder.create().uv(207, 19).cuboid(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -1.309F, 0.0F, 0.0F));

		ModelPartData tinygear2 = gears.addChild("tinygear2", ModelPartBuilder.create(), ModelTransform.pivot(2.5F, -14.5608F, -0.1922F));

		ModelPartData cube_r33 = tinygear2.addChild("cube_r33", ModelPartBuilder.create().uv(207, 16).cuboid(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -1.309F, 0.0F, 0.0F));
		...
		ModelPartData cube_r38 = panel3.addChild("cube_r38", ModelPartBuilder.create().uv(171, 0).cuboid(-1.0F, -15.5F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-13.9308F, 7.7695F, -16.6289F, 0.0F, 0.5236F, 0.0F));

		ModelPartData cube_r39 = panel3.addChild("cube_r39", ModelPartBuilder.create().uv(176, 135).cuboid(-1.0F, -21.023F, -24.3765F, 2.0F, 2.0F, 20.0F, new Dilation(0.001F)), ModelTransform.of(0.1274F, 6.25F, 7.7207F, 0.2618F, 0.5236F, 0.0F));

		ModelPartData cube_r40 = panel3.addChild("cube_r40", ModelPartBuilder.create().uv(0, 0).cuboid(-14.0F, -17.9761F, -0.0344F, 28.0F, 18.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.1274F, -0.0613F, -0.0293F, 1.309F, 0.0F, 0.0F));

		ModelPartData cube_r41 = panel3.addChild("cube_r41", ModelPartBuilder.create().uv(108, 64).cuboid(-14.0F, -17.6235F, -14.523F, 28.0F, 18.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.1274F, 6.25F, -13.2793F, -1.309F, 0.0F, 0.0F));

		ModelPartData lights = panel3.addChild("lights", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData bone2 = lights.addChild("bone2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.5F, -1.75F));

		ModelPartData cube_r42 = bone2.addChild("cube_r42", ModelPartBuilder.create().uv(113, 42).cuboid(6.1F, -12.9F, -4.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));

		ModelPartData lights2 = bone2.addChild("lights2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r43 = lights2.addChild("cube_r43", ModelPartBuilder.create().uv(202, 123).cuboid(6.1F, -10.9681F, -4.5176F, 1.0F, 1.0F, 1.0F, new Dilation(0.01F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));

		ModelPartData bone = lights.addChild("bone", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r44 = bone.addChild("cube_r44", ModelPartBuilder.create().uv(100, 201).cuboid(6.1F, -12.9F, -4.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));

		ModelPartData lights1 = bone.addChild("lights1", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r45 = lights1.addChild("cube_r45", ModelPartBuilder.create().uv(25, 204).cuboid(6.1F, -10.9681F, -4.5176F, 1.0F, 1.0F, 1.0F, new Dilation(0.01F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));
		...
		ModelPartData cube_r47 = sonicport.addChild("cube_r47", ModelPartBuilder.create().uv(165, 135).cuboid(0.35F, -1.0F, -0.95F, 0.0F, 2.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-6.5F, -20.5F, -17.0F, 0.0F, 0.7854F, 0.0F));

		ModelPartData speaker = controls5.addChild("speaker", ModelPartBuilder.create(), ModelTransform.pivot(4.5F, -19.6609F, -15.1033F));

		ModelPartData cube_r48 = speaker.addChild("cube_r48", ModelPartBuilder.create().uv(171, 13).cuboid(-3.0F, -0.1F, -1.9F, 4.0F, 0.0F, 4.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));

		ModelPartData cube_r49 = speaker.addChild("cube_r49", ModelPartBuilder.create().uv(180, 149).cuboid(-2.25F, -1.0F, -2.15F, 3.0F, 2.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.3622F, 0.7519F, 0.2533F));
		...
		ModelPartData slider2 = sliders.addChild("slider2", ModelPartBuilder.create().uv(55, 205).cuboid(-3.25F, -21.4516F, -14.9982F, 1.0F, 1.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData slider3 = sliders.addChild("slider3", ModelPartBuilder.create().uv(60, 205).cuboid(-2.25F, -21.4516F, -14.9982F, 1.0F, 1.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData slider4 = sliders.addChild("slider4", ModelPartBuilder.create().uv(65, 205).cuboid(-1.25F, -21.4516F, -14.9982F, 1.0F, 1.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData slider5 = sliders.addChild("slider5", ModelPartBuilder.create().uv(75, 205).cuboid(-0.25F, -21.4516F, -14.9982F, 1.0F, 1.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData cube_r53 = panel4.addChild("cube_r53", ModelPartBuilder.create().uv(77, 178).cuboid(-1.0F, -15.5F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-14.0582F, 0.5195F, -24.3496F, 0.0F, 0.5236F, 0.0F));
		...
		ModelPartData tinyswitch = controls4.addChild("tinyswitch", ModelPartBuilder.create(), ModelTransform.pivot(11.5F, -15.1847F, -23.2096F));

		ModelPartData cube_r57 = tinyswitch.addChild("cube_r57", ModelPartBuilder.create().uv(105, 142).cuboid(1.25F, -1.15F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(-1.5F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));
		...
		ModelPartData cube_r60 = lockernob.addChild("cube_r60", ModelPartBuilder.create().uv(202, 13).cuboid(-2.5F, -22.4F, -15.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));

		ModelPartData lockernob6 = controls4.addChild("lockernob6", ModelPartBuilder.create(), ModelTransform.pivot(1.5F, 0.0F, 0.0F));

		ModelPartData cube_r61 = lockernob6.addChild("cube_r61", ModelPartBuilder.create().uv(202, 4).cuboid(-2.0F, -22.4F, -15.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));

		ModelPartData lockernob7 = controls4.addChild("lockernob7", ModelPartBuilder.create(), ModelTransform.pivot(3.0F, 0.0F, 0.0F));

		ModelPartData cube_r62 = lockernob7.addChild("cube_r62", ModelPartBuilder.create().uv(202, 0).cuboid(-1.5F, -22.4F, -15.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));
		...
		ModelPartData coloredlever3 = controls4.addChild("coloredlever3", ModelPartBuilder.create().uv(183, 120).cuboid(-0.75F, -3.0F, 0.0F, 1.0F, 3.0F, 0.0F, new Dilation(0.001F)), ModelTransform.pivot(1.5F, -19.25F, -12.0F));

		ModelPartData coloredlever4 = controls4.addChild("coloredlever4", ModelPartBuilder.create().uv(184, 101).cuboid(-0.5F, -3.0F, 0.0F, 1.0F, 3.0F, 0.0F, new Dilation(0.001F)), ModelTransform.pivot(2.75F, -19.25F, -12.0F));
		...
		ModelPartData red2 = handbrakelights2.addChild("red2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r67 = red2.addChild("cube_r67", ModelPartBuilder.create().uv(113, 27).cuboid(-5.5F, -1.0541F, 1.25F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(13.0F, 0.0522F, 0.014F, 0.2618F, 0.0F, 0.0F));

		ModelPartData red1 = handbrakelights2.addChild("red1", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r68 = red1.addChild("cube_r68", ModelPartBuilder.create().uv(175, 30).cuboid(-4.0F, -1.0541F, 0.75F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(13.0F, 0.0522F, 0.014F, 0.2618F, 0.0F, 0.0F));

		ModelPartData yellow2 = handbrakelights2.addChild("yellow2", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r69 = yellow2.addChild("cube_r69", ModelPartBuilder.create().uv(186, 25).cuboid(-2.5F, -1.0541F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(13.0F, 0.0522F, 0.014F, 0.2618F, 0.0F, 0.0F));

		ModelPartData yellow1 = handbrakelights2.addChild("yellow1", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r70 = yellow1.addChild("cube_r70", ModelPartBuilder.create().uv(158, 189).cuboid(-2.0F, -1.0541F, -2.0F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(13.0F, 0.0522F, 0.014F, 0.2618F, 0.0F, 0.0F));

		ModelPartData yellow6 = panel4.addChild("yellow6", ModelPartBuilder.create(), ModelTransform.pivot(-14.0F, -15.7382F, -20.3305F));

		ModelPartData cube_r71 = yellow6.addChild("cube_r71", ModelPartBuilder.create().uv(51, 119).cuboid(-2.5F, -0.0881F, -0.7588F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(19.0F, 0.8022F, -1.236F, 0.2618F, 0.0F, 0.0F));

		ModelPartData yellow5 = panel4.addChild("yellow5", ModelPartBuilder.create(), ModelTransform.pivot(-14.0F, -15.7382F, -20.3305F));

		ModelPartData cube_r72 = yellow5.addChild("cube_r72", ModelPartBuilder.create().uv(91, 147).cuboid(-2.5F, -0.0881F, -0.7588F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(17.0F, 0.8022F, -1.236F, 0.2618F, 0.0F, 0.0F));

		ModelPartData yellow4 = panel4.addChild("yellow4", ModelPartBuilder.create(), ModelTransform.pivot(-16.0F, -15.7382F, -20.3305F));

		ModelPartData cube_r73 = yellow4.addChild("cube_r73", ModelPartBuilder.create().uv(103, 147).cuboid(-2.5F, -0.0881F, -0.7588F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(17.0F, 0.8022F, -1.236F, 0.2618F, 0.0F, 0.0F));

		ModelPartData yellow3 = panel4.addChild("yellow3", ModelPartBuilder.create(), ModelTransform.pivot(-16.0F, -15.7382F, -20.3305F));

		ModelPartData cube_r74 = yellow3.addChild("cube_r74", ModelPartBuilder.create().uv(165, 148).cuboid(-2.5F, -0.0881F, -0.7588F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(15.0F, 0.8022F, -1.236F, 0.2618F, 0.0F, 0.0F));
		...
		ModelPartData cube_r75 = panel5.addChild("cube_r75", ModelPartBuilder.create().uv(165, 60).cuboid(-1.0F, -8.023F, -31.6235F, 2.0F, 2.0F, 22.0F, new Dilation(-0.001F)), ModelTransform.of(0.0F, 2.0391F, 0.0F, -0.2618F, 0.5236F, 0.0F));

		ModelPartData cube_r76 = panel5.addChild("cube_r76", ModelPartBuilder.create().uv(62, 178).cuboid(-1.0F, -15.5F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-14.0582F, 0.5195F, -24.3496F, 0.0F, 0.5236F, 0.0F));

		ModelPartData cube_r77 = panel5.addChild("cube_r77", ModelPartBuilder.create().uv(37, 178).cuboid(-1.0F, -21.023F, -24.3765F, 2.0F, 2.0F, 20.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.2618F, 0.5236F, 0.0F));
		...
		ModelPartData cube_r80 = panel6.addChild("cube_r80", ModelPartBuilder.create().uv(165, 85).cuboid(-1.0F, -8.023F, -31.6235F, 2.0F, 2.0F, 22.0F, new Dilation(-0.001F)), ModelTransform.of(0.0F, 2.0391F, 0.0F, -0.2618F, 0.5236F, 0.0F));

		ModelPartData cube_r81 = panel6.addChild("cube_r81", ModelPartBuilder.create().uv(178, 76).cuboid(-1.0F, -15.5F, -1.0F, 2.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-14.0582F, 0.5195F, -24.3496F, 0.0F, 0.5236F, 0.0F));

		ModelPartData cube_r82 = panel6.addChild("cube_r82", ModelPartBuilder.create().uv(82, 178).cuboid(-1.0F, -21.023F, -24.3765F, 2.0F, 2.0F, 20.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.2618F, 0.5236F, 0.0F));
		...
		ModelPartData cube_r85 = gallifreyanball.addChild("cube_r85", ModelPartBuilder.create().uv(192, 85).cuboid(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(-0.25F)), ModelTransform.of(0.0F, 0.0259F, -0.0966F, 0.2618F, 0.0F, 0.0F));
		...
		ModelPartData tinyswitches1 = tinyswitches.addChild("tinyswitches1", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r88 = tinyswitches1.addChild("cube_r88", ModelPartBuilder.create().uv(165, 129).cuboid(-9.0F, 3.0F, 4.5F, 4.0F, 2.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(7.0F, -2.8198F, -5.4143F, 0.2618F, 0.0F, 0.0F));

		ModelPartData smallnob3 = controls2.addChild("smallnob3", ModelPartBuilder.create().uv(203, 171).cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-5.5F, -15.5606F, -22.6996F, 0.2618F, 0.0F, 0.0F));

		ModelPartData smallnob4 = controls2.addChild("smallnob4", ModelPartBuilder.create().uv(203, 162).cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(5.5F, -15.5606F, -22.6996F, 0.2618F, 0.0F, 0.0F));

		ModelPartData smallnob5 = controls2.addChild("smallnob5", ModelPartBuilder.create().uv(203, 158).cuboid(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-3.5F, -15.3106F, -23.6996F, 0.2618F, 0.0F, 0.0F));
		...
		ModelPartData cube_r89 = middlegallifreyan.addChild("cube_r89", ModelPartBuilder.create().uv(104, 49).cuboid(-3.0F, -3.0F, 0.0F, 6.0F, 6.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -1.309F, 0.0F, 0.0F));

		ModelPartData rightgallifreyan = gallifreyan.addChild("rightgallifreyan", ModelPartBuilder.create(), ModelTransform.pivot(4.5F, 0.0F, 0.0F));

		ModelPartData cube_r90 = rightgallifreyan.addChild("cube_r90", ModelPartBuilder.create().uv(194, 188).cuboid(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.25F, 0.0F, 0.0F, -1.309F, 0.0F, 0.0F));

		ModelPartData leftgallifreyan = gallifreyan.addChild("leftgallifreyan", ModelPartBuilder.create(), ModelTransform.pivot(-4.5F, 0.0F, 0.0F));

		ModelPartData cube_r91 = leftgallifreyan.addChild("cube_r91", ModelPartBuilder.create().uv(89, 194).cuboid(-1.5F, -1.5F, 0.0F, 3.0F, 3.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(-0.25F, 0.0F, 0.0F, -1.309F, 0.0F, 0.0F));

		ModelPartData switchlights2 = panel6.addChild("switchlights2", ModelPartBuilder.create(), ModelTransform.pivot(-6.75F, -14.9359F, -20.3165F));

		ModelPartData cube_r92 = switchlights2.addChild("cube_r92", ModelPartBuilder.create().uv(66, 44).cuboid(6.25F, -1.8591F, 7.8848F, 1.0F, 2.0F, 1.0F, new Dilation(-0.25F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.2618F, 0.0F, 0.0F));

		ModelPartData switchlights3 = switchlights2.addChild("switchlights3", ModelPartBuilder.create(), ModelTransform.pivot(1.0F, 0.9478F, -0.014F));
		...
		ModelPartData cube_r97 = top.addChild("cube_r97", ModelPartBuilder.create().uv(211, 190).cuboid(-7.75F, -30.0F, -4.5F, 2.0F, 1.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -17.0F, 0.0F, -3.1416F, 0.5236F, 3.1416F));

		ModelPartData cube_r98 = top.addChild("cube_r98", ModelPartBuilder.create().uv(174, 209).cuboid(-7.75F, -30.0F, -4.5F, 2.0F, 1.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -17.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		ModelPartData cube_r99 = top.addChild("cube_r99", ModelPartBuilder.create().uv(151, 209).cuboid(-7.75F, -30.0F, -4.5F, 2.0F, 1.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -17.0F, 0.0F, -3.1416F, -0.5236F, 3.1416F));

		ModelPartData cube_r100 = top.addChild("cube_r100", ModelPartBuilder.create().uv(207, 75).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -15.0F, 0.0F, 0.0F, 1.5708F, 0.0F));

		ModelPartData cube_r101 = top.addChild("cube_r101", ModelPartBuilder.create().uv(207, 59).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -15.0F, 0.0F, -3.1416F, 0.5236F, 3.1416F));

		ModelPartData cube_r102 = top.addChild("cube_r102", ModelPartBuilder.create().uv(15, 207).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -15.0F, 0.0F, -3.1416F, -0.5236F, 3.1416F));

		ModelPartData cube_r103 = top.addChild("cube_r103", ModelPartBuilder.create().uv(205, 25).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -15.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		ModelPartData cube_r104 = toprotor.addChild("cube_r104", ModelPartBuilder.create().uv(77, 148).cuboid(-7.75F, -30.0F, -4.5F, 2.0F, 1.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -3.1416F, -0.5236F, 3.1416F));

		ModelPartData cube_r105 = toprotor.addChild("cube_r105", ModelPartBuilder.create().uv(167, 188).cuboid(-7.75F, -30.0F, -4.5F, 2.0F, 1.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -3.1416F, 0.5236F, 3.1416F));

		ModelPartData cube_r106 = toprotor.addChild("cube_r106", ModelPartBuilder.create().uv(165, 135).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 2.0F, 0.0F, -3.1416F, 0.5236F, 3.1416F));

		ModelPartData cube_r107 = toprotor.addChild("cube_r107", ModelPartBuilder.create().uv(171, 0).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 2.0F, 0.0F, -3.1416F, -0.5236F, 3.1416F));

		ModelPartData cube_r108 = toprotor.addChild("cube_r108", ModelPartBuilder.create().uv(194, 188).cuboid(-7.75F, -30.0F, -4.5F, 2.0F, 1.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		ModelPartData cube_r113 = toprotor.addChild("cube_r113", ModelPartBuilder.create().uv(127, 189).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 2.0F, 0.0F, 0.0F, 1.5708F, 0.0F));

		ModelPartData monitors = top.addChild("monitors", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, -47.0F, 0.0F));
		...
		ModelPartData cube_r118 = bottom.addChild("cube_r118", ModelPartBuilder.create().uv(218, 155).cuboid(0.0F, -9.0F, 6.5F, 0.0F, 7.0F, 3.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -27.0F, 0.0F, -3.1416F, -0.5236F, 3.1416F));

		ModelPartData cube_r119 = bottom.addChild("cube_r119", ModelPartBuilder.create().uv(92, 178).cuboid(0.0F, -9.0F, 6.5F, 0.0F, 7.0F, 3.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -27.0F, 0.0F, -3.1416F, 0.5236F, 3.1416F));

		ModelPartData cube_r120 = bottom.addChild("cube_r120", ModelPartBuilder.create().uv(183, 220).cuboid(0.0F, -9.0F, 6.5F, 0.0F, 7.0F, 3.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -27.0F, 0.0F, 0.0F, -0.5236F, 0.0F));

		ModelPartData cube_r121 = bottom.addChild("cube_r121", ModelPartBuilder.create().uv(176, 220).cuboid(0.0F, -9.0F, 6.5F, 0.0F, 7.0F, 3.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -27.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		ModelPartData cube_r122 = bottom.addChild("cube_r122", ModelPartBuilder.create().uv(221, 22).cuboid(0.0F, -9.0F, 6.5F, 0.0F, 7.0F, 3.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -27.0F, 0.0F, 0.0F, 0.5236F, 0.0F));

		ModelPartData cube_r123 = bottom.addChild("cube_r123", ModelPartBuilder.create().uv(221, 125).cuboid(0.0F, -9.0F, 6.5F, 0.0F, 7.0F, 3.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -27.0F, 0.0F, 0.0F, 1.5708F, 0.0F));

		ModelPartData cube_r124 = bottom.addChild("cube_r124", ModelPartBuilder.create().uv(146, 215).cuboid(-0.1F, -27.0F, -5.75F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.25F, -16.0F, 0.5F, 0.0F, 0.5236F, 0.0F));

		ModelPartData cube_r125 = bottom.addChild("cube_r125", ModelPartBuilder.create().uv(191, 25).cuboid(-0.5F, -27.0F, -6.0F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.25F, -16.0F, 0.5F, 0.0F, -0.5236F, 0.0F));

		ModelPartData cube_r126 = bottom.addChild("cube_r126", ModelPartBuilder.create().uv(190, 158).cuboid(-0.9F, -27.0F, -5.25F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.25F, -16.0F, 0.5F, -3.1416F, -0.5236F, 3.1416F));

		ModelPartData cube_r127 = bottom.addChild("cube_r127", ModelPartBuilder.create().uv(190, 135).cuboid(-0.9F, -27.0F, -5.75F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.25F, -16.0F, 0.5F, 0.0F, -1.5708F, 0.0F));

		ModelPartData cube_r128 = bottom.addChild("cube_r128", ModelPartBuilder.create().uv(185, 158).cuboid(-0.1F, -27.0F, -5.25F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.25F, -16.0F, 0.5F, 0.0F, 1.5708F, 0.0F));

		ModelPartData cube_r129 = bottom.addChild("cube_r129", ModelPartBuilder.create().uv(50, 180).cuboid(-0.5F, -27.0F, -5.0F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.25F, -16.0F, 0.5F, -3.1416F, 0.5236F, 3.1416F));

		ModelPartData cube_r130 = bottom.addChild("cube_r130", ModelPartBuilder.create().uv(20, 220).cuboid(-0.1F, -27.0F, -5.75F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -16.0F, 0.5F, 0.0F, 1.0472F, 0.0F));

		ModelPartData cube_r131 = bottom.addChild("cube_r131", ModelPartBuilder.create().uv(15, 220).cuboid(-0.5F, -27.0F, -6.0F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -16.0F, 0.5F, 0.0F, 0.0F, 0.0F));

		ModelPartData cube_r132 = bottom.addChild("cube_r132", ModelPartBuilder.create().uv(10, 217).cuboid(-0.9F, -27.0F, -5.25F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -16.0F, 0.5F, -3.1416F, -1.0472F, 3.1416F));

		ModelPartData cube_r133 = bottom.addChild("cube_r133", ModelPartBuilder.create().uv(5, 217).cuboid(-0.9F, -27.0F, -5.75F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -16.0F, 0.5F, 0.0F, -1.0472F, 0.0F));

		ModelPartData cube_r134 = bottom.addChild("cube_r134", ModelPartBuilder.create().uv(0, 217).cuboid(-0.1F, -27.0F, -5.25F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -16.0F, 0.5F, 3.1416F, 1.0472F, 3.1416F));
		...
		ModelPartData cube_r138 = bottom.addChild("cube_r138", ModelPartBuilder.create().uv(202, 214).cuboid(-7.75F, -30.0F, -4.5F, 2.0F, 1.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		ModelPartData cube_r139 = bottom.addChild("cube_r139", ModelPartBuilder.create().uv(192, 56).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 2.0F, 0.0F, -3.1416F, -0.5236F, 3.1416F));

		ModelPartData cube_r140 = bottom.addChild("cube_r140", ModelPartBuilder.create().uv(123, 215).cuboid(-7.75F, -30.0F, -4.5F, 2.0F, 1.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -3.1416F, -0.5236F, 3.1416F));

		ModelPartData cube_r141 = bottom.addChild("cube_r141", ModelPartBuilder.create().uv(54, 214).cuboid(-7.75F, -30.0F, -4.5F, 2.0F, 1.0F, 9.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -3.1416F, 0.5236F, 3.1416F));

		ModelPartData cube_r142 = bottom.addChild("cube_r142", ModelPartBuilder.create().uv(35, 201).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 2.0F, 0.0F, -3.1416F, 0.5236F, 3.1416F));
		...
		ModelPartData cube_r146 = bottom.addChild("cube_r146", ModelPartBuilder.create().uv(202, 0).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -5.5F, 0.0F, 0.0F, -1.5708F, 0.0F));

		ModelPartData cube_r147 = bottom.addChild("cube_r147", ModelPartBuilder.create().uv(201, 135).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -5.5F, 0.0F, -3.1416F, -0.5236F, 3.1416F));

		ModelPartData cube_r148 = bottom.addChild("cube_r148", ModelPartBuilder.create().uv(110, 201).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -5.5F, 0.0F, -3.1416F, 0.5236F, 3.1416F));

		ModelPartData cube_r149 = bottom.addChild("cube_r149", ModelPartBuilder.create().uv(85, 201).cuboid(-8.65F, -31.0F, -5.0F, 2.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -5.5F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		ModelPartData cube_r150 = glass.addChild("cube_r150", ModelPartBuilder.create().uv(0, 76).cuboid(-4.0F, -75.0F, -6.9F, 8.0F, 58.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 16.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));

		ModelPartData cube_r151 = glass.addChild("cube_r151", ModelPartBuilder.create().uv(74, 64).cuboid(-4.0F, -75.0F, -6.9F, 8.0F, 58.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 16.0F, 0.0F, -3.1416F, -1.0472F, 3.1416F));

		ModelPartData cube_r152 = glass.addChild("cube_r152", ModelPartBuilder.create().uv(57, 64).cuboid(-4.0F, -75.0F, -6.9F, 8.0F, 58.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 16.0F, 0.0F, -3.1416F, 1.0472F, 3.1416F));

		ModelPartData cube_r153 = glass.addChild("cube_r153", ModelPartBuilder.create().uv(17, 76).cuboid(-4.0F, -75.0F, -6.9F, 8.0F, 58.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 16.0F, 0.0F, 0.0F, -1.0472F, 0.0F));

		ModelPartData cube_r154 = glass.addChild("cube_r154", ModelPartBuilder.create().uv(91, 64).cuboid(-4.0F, -75.0F, -6.9F, 8.0F, 58.0F, 0.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, 16.0F, 0.0F, 0.0F, 1.0472F, 0.0F));

		ModelPartData rotor = toyota.addChild("rotor", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r155 = rotor.addChild("cube_r155", ModelPartBuilder.create().uv(0, 180).cuboid(-1.0F, -33.0F, -5.25F, 2.0F, 13.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, 0.0F, 3.1416F, -1.0472F, -3.1416F));

		ModelPartData cube_r156 = rotor.addChild("cube_r156", ModelPartBuilder.create().uv(178, 85).cuboid(-1.0F, -33.0F, -5.25F, 2.0F, 13.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, 0.0F, 3.1416F, 0.0F, -3.1416F));

		ModelPartData cube_r157 = rotor.addChild("cube_r157", ModelPartBuilder.create().uv(178, 60).cuboid(-1.0F, -33.0F, -5.25F, 2.0F, 13.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, 0.0F, 3.1416F, 1.0472F, -3.1416F));

		ModelPartData cube_r158 = rotor.addChild("cube_r158", ModelPartBuilder.create().uv(176, 158).cuboid(-1.0F, -33.0F, -5.25F, 2.0F, 13.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, 0.0F, 0.0F, 1.0472F, 0.0F));

		ModelPartData cube_r159 = rotor.addChild("cube_r159", ModelPartBuilder.create().uv(174, 110).cuboid(-1.0F, -33.0F, -5.0F, 2.0F, 13.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, -0.25F, 0.0F, 0.0F, 0.0F));

		ModelPartData cube_r160 = rotor.addChild("cube_r160", ModelPartBuilder.create().uv(165, 110).cuboid(-1.0F, -33.0F, -5.25F, 2.0F, 13.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, 0.0F, 0.0F, -1.0472F, 0.0F));

		ModelPartData cube_r161 = rotor.addChild("cube_r161", ModelPartBuilder.create().uv(9, 180).cuboid(-1.0F, -33.0F, -5.25F, 2.0F, 11.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -83.0F, 0.0F, 3.1416F, 1.0472F, 0.0F));

		ModelPartData cube_r162 = rotor.addChild("cube_r162", ModelPartBuilder.create().uv(104, 34).cuboid(-1.0F, -33.0F, -5.25F, 2.0F, 11.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -83.0F, 0.0F, 0.0F, 1.0472F, 3.1416F));

		ModelPartData cube_r163 = rotor.addChild("cube_r163", ModelPartBuilder.create().uv(104, 19).cuboid(-1.0F, -33.0F, -5.0F, 2.0F, 11.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -83.0F, -0.25F, 0.0F, 0.0F, 3.1416F));

		ModelPartData cube_r164 = rotor.addChild("cube_r164", ModelPartBuilder.create().uv(57, 49).cuboid(-1.0F, -33.0F, -5.25F, 2.0F, 11.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -83.0F, 0.0F, 0.0F, -1.0472F, 3.1416F));

		ModelPartData cube_r165 = rotor.addChild("cube_r165", ModelPartBuilder.create().uv(57, 34).cuboid(-1.0F, -33.0F, -5.25F, 2.0F, 11.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -83.0F, 0.0F, 3.1416F, -1.0472F, 0.0F));

		ModelPartData cube_r166 = rotor.addChild("cube_r166", ModelPartBuilder.create().uv(57, 19).cuboid(-1.0F, -33.0F, -5.25F, 2.0F, 11.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -83.0F, 0.0F, 3.1416F, 0.0F, 0.0F));

		ModelPartData rotorlights = rotor.addChild("rotorlights", ModelPartBuilder.create().uv(166, 220).cuboid(-0.5F, -29.0F, -5.25F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -21.0F, 0.5F));

		ModelPartData cube_r167 = rotorlights.addChild("cube_r167", ModelPartBuilder.create().uv(151, 220).cuboid(-0.1F, -27.0F, -4.5F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, 0.0F, 0.0F, 2.0944F, 0.0F));

		ModelPartData cube_r168 = rotorlights.addChild("cube_r168", ModelPartBuilder.create().uv(25, 220).cuboid(-0.1F, -27.0F, -5.0F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, 0.0F, 0.0F, 1.0472F, 0.0F));

		ModelPartData cube_r169 = rotorlights.addChild("cube_r169", ModelPartBuilder.create().uv(156, 220).cuboid(-0.9F, -27.0F, -5.0F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, 0.0F, 0.0F, -1.0472F, 0.0F));

		ModelPartData cube_r170 = rotorlights.addChild("cube_r170", ModelPartBuilder.create().uv(161, 220).cuboid(-0.9F, -27.0F, -4.5F, 1.0F, 15.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.0F, 0.0F, 0.0F, -2.0944F, 0.0F));
	...
	public void renderWithAnimations(ConsoleBlockEntity console, ModelPart root, MatrixStack matrices, VertexConsumer vertices, int light, int overlay, float red, float green, float blue, float pAlpha) {
		...
		direction.pitch = console.getTardis().getTravel().getDestination().getDirection() == Direction.NORTH ? console.getTardis().getTravel().getDestination().getDirection() == Direction.EAST ? console.getTardis().getTravel().getDestination().getDirection() == Direction.SOUTH ? console.getTardis().getTravel().getDestination().getDirection() == Direction.WEST ? direction.pitch : direction.pitch + 1f : direction.pitch + 2f : direction.pitch + 3f;
